        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form action="{{ route('cerita.update', $data->slug) }}" class="mt-2" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-2">
                                    ...
                                    <select class="select2 form-select" name="is_publish" required>
                                        <option value="0" @selected(!$data->is_publish)>Tidak</option>
                                        <option value="1" @selected($data->is_publish)>Ya</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <textarea id="editor" class="editor" name="content">{{ $data->content }}</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex flex-column flex-md-row">
                                        ...
                                        <div class="featured-info">
                                            ...
                                            <div class="d-inline-block">
                                                <input name="photo_background" class="form-control" type="file" accept="image/*" />
                            ...
                            <div class="col-12 mt-50">
                                <button type="submit" class="btn btn-warning me-1">Ubah</button>
                            </div>
                        </div>
                    </form>
                    <!--/ Form -->
